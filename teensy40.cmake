...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${OBJECT_GEN_FLAGS} -D__IMXRT1062__ -DF_CPU=600000000" CACHE INTERNAL "C Compiler options")
set(CMAKE_CXX_FLAGS "-fno-unwind-tables -fno-exceptions -fpermissive -fno-rtti -fno-threadsafe-statics -felide-constructors -Wno-error=narrowing ${CMAKE_CXX_FLAGS} ${OBJECT_GEN_FLAGS} -D__IMXRT1062__ -DF_CPU=600000000" CACHE INTERNAL "C++ Compiler options")
